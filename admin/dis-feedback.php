                  ...
                  <?php
                      ...
                      while ($row = mysqli_fetch_array($q)){
                        ...
                        $udata = mysqli_fetch_array($uq);
                          ...
                          echo "<td class='btn-primary'><a class='text-white' href='edit-feedback.php?eid={$row['feedback_id']}'> Edit </a></td>";
                          echo "<td class='btn-danger'><a class='text-white' href='dis-feedback.php?did={$row['feedback_id']}'> Delete</a></td>";
