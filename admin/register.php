<?php
  ...
  if($_POST){
    ...
    $admin_npassword = $_POST['npassword'];
    $admin_cpassword = $_POST['cpassword'];
    if($admin_cpassword = $admin_npassword){
      $q = mysqli_query($connection,"insert into tbl_admin 
    (admin_name,email_id,admin_password)
    values ('{$admin_name}','{$email_id}','{$admin_cpassword}')");
      if($q){
        echo "<script>alert('register successful');window.location='home.php';</script>";
      }
    }else{
      echo "<script>alert('register failed');window.location='home.php';</script>";
  }
}
?>
<!DOCTYPE html>
