...
require 'admin/class/at-class.php';
    if($_POST){
     ...
     $uid = $_SESSION['uid'];
      ...
      $q = mysqli_query($connection,"insert into tbl_booking(booking_status,booking_purpose,date_time,user_id,artist_id) 
       values('{$booking_status}','{$booking_purpose}','{$date_time}','{$uid}','{$aid}')");
                	...
                	<div class="sf-provi-qform">
                        <form action="" method="post" id="myform">
                            ...
                            <div class="form-group">
                                <label>Message</label>
                                <textarea name="booking_purpose" rows="4" class="form-control" required></textarea>
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-group">
                            <label>Datetime</label>
                               <input type="datetime-local" name="date_time" id="" class="form-control" required>
                            </div>
                            </div>
                            ...
                            <div class="form-group text-center qout-submit-btn">
                                <input type="submit" value="Submit" class="site-button" required>
                            </div>
                            </div>
                            </div>
                        </form>
