...
session_start();
  ...
  if($_POST){
    ...
    $q = mysqli_query($connection,"select * from tbl_artist where email_id  = '{$email_id}'");
    $count = mysqli_num_rows($q); 
    if($count == 1)
    {
      $data = mysqli_fetch_array($q);
      echo $data['artist_password'];
      $msg = "hello <br/>your password is " . $data['artist_password'];
