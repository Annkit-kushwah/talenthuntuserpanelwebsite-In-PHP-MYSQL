...
<div id="aon-provider-services" class="sf-provi-service-box m-b50 sf-provi-fullBox">
                    <h3 class="sf-provi-title">Customer View Booking </h3>
                    <div class="sf-divider-line"></div>
                    <ul class="sf-provi-service-list">
                    <?php
$bq = mysqli_query($connection, "SELECT * FROM tbl_booking where user_id = '{$_SESSION['uid']}'");
while ($bdata = mysqli_fetch_array($bq)){
    $uq = mysqli_query($connection, "SELECT * FROM tbl_artist  WHERE artist_id = '{$bdata['artist_id']}'   ");
                        ...
                        <li class="sf-provi-service-box">
                            ...
                            <div class="sf-provi-service-top">
                                <div class="sf-provi-service-left">
                                    <h4 class="sf-provi-service-ttle"> <?php echo $udata['artist_name'] ?> </h4>
